...
impl<'a> Lexer<'a> {
    ...
    fn classify_identifier(&self, ident: &str) -> Kind {
        match ident {
            ...
            | "opheld" | "opheld1" | "opheld2" | "opheld3" | "opheld4" | "opheld5" | "opheld6"
            | "opheld7" | "opheld8" | "opheld9" | "opheld10" | "oplocu" | "opobju" | "opnpcu"
            | "opplayeru" | "opheldu" | "opnpct" | "oploct" | "opplayert" | "opheldt"
            | "opobjt" | "apnpc" | "apnpc1" | "apnpc2" | "apnpc3" | "apnpc4" | "apnpc5"
            | "aploc" | "aploc1" | "aploc2" | "aploc3" | "aploc4" | "aploc5" | "apobj"
            | "apobj1" | "apobj2" | "apobj3" | "apobj4" | "apobj5" | "applayer" | "applayer1"
            | "applayer2" | "applayer3" | "applayer4" | "applayer5" | "if_button" | "if_close"
            | "login" | "logout" | "inv_button1" | "inv_button2" | "inv_button3"
